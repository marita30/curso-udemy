...
const burger = (props) => {
    ...
    caso covertira el state de los ingredientes en un string, luego lo mapeamos porque ya es una matriz para poder recorrerla, igKey para la clave de ingrediente*/
