        ...
        return (
            <div>
                ...
                <Route 
                    ...
                    render={(props)=> ( <ContactData ingredients={this.state.ingredients} price={this.state.totalPrice} {...props} /> )} /* {...props} aquis e tomara todos los datos de contactData.js que tomara props.history */
                />
            </div>
        );
    }
